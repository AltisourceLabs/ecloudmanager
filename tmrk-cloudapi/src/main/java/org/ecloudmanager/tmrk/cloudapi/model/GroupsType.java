 ...
 *       &lt;sequence>
 *         &lt;element name="Group" type="{}LayoutGroupType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GroupsType {
    ...
    protected List<LayoutGroupType> group;
     ...
     * {@link LayoutGroupType }
     */
    public List<LayoutGroupType> getGroup() {
        if (group == null) {
            group = new ArrayList<LayoutGroupType>();
        }
        return this.group;
    }
