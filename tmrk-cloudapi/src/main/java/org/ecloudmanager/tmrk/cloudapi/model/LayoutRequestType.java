...
@XmlType(name = "LayoutRequestType", propOrder = {
    "row",
    "group",
    "newRow",
    "newGroup"
})
public class LayoutRequestType implements Serializable {

    private static final long serialVersionUID = 915798354994466755L;
    ...
    @XmlElementRef(name = "NewRow", type = JAXBElement.class, required = false)
    protected JAXBElement<String> newRow;
    @XmlElementRef(name = "NewGroup", type = JAXBElement.class, required = false)
    protected JAXBElement<String> newGroup;
     ...
     *     
     */
    public JAXBElement<String> getNewRow() {
        return newRow;
    }
     ...
     *     
     */
    public void setNewRow(JAXBElement<String> value) {
        this.newRow = value;
    }
     ...
     *     
     */
    public JAXBElement<String> getNewGroup() {
        return newGroup;
    }
     ...
     *     
     */
    public void setNewGroup(JAXBElement<String> value) {
        this.newGroup = value;
    }
