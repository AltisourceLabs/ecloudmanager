...
public class GitInfo {
    ...
    public static GitInfo get() throws IOException {
        if (gitInfo == null) {
            Properties properties = new Properties();
            properties.load(GitInfo.class.getClassLoader().getResourceAsStream("git.properties"));

            gitInfo = new GitInfo(properties);
        }
        return gitInfo;
    }
